...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.PeerData = app_1.App;
	var config_1 = __webpack_require__(6);
	exports.PeerDataConfig = config_1.Config;
	var bridge_1 = __webpack_require__(65);
	exports.PeerDataBridge = bridge_1.Bridge;
	var log_level_1 = __webpack_require__(8);
	exports.LogLevel = log_level_1.LogLevel;
	var event_type_1 = __webpack_require__(5);
	exports.SignalingEventType = event_type_1.SignalingEventType;
	var event_type_2 = __webpack_require__(68);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const dispatcher_1 = __webpack_require__(4);
	const event_type_1 = __webpack_require__(5);
	exports.CONFIG = {
	    servers: null,
	    logger: null,
	    signalling: null,
	...
	class App {
	    constructor(conf) {
	        if (conf) {
	            exports.CONFIG.servers = conf.servers;
	            exports.CONFIG.logger = conf.logger;
	            exports.CONFIG.signalling = conf.signalling;
	            exports.CONFIG.connection = conf.connection;
	        }
	    }
	    on(event, callback) {
	    ...
	    send(data) {
	        Object.entries(exports.CONFIG.connection.channels)
	    ...
	    connect() {
	        ...
	        exports.CONFIG.signalling.send(event);
	    }
	    disconnect() {
	        Object.entries(exports.CONFIG.connection.channels)
	            .forEach(([key, value]) => value.close());
	        Object.entries(exports.CONFIG.connection.peers)
	            .forEach(([key, value]) => {
	            value.close();
	            let event = {
	    ...
	    peers() {
	        return exports.CONFIG.connection.peers;
	    }
	    channels() {
	        return exports.CONFIG.connection.channels;
	    }
	}
	exports.App = App;
...
/***/ function(module, exports) {
	...
	class EventDispatcher {
	    ...
	    static dispatch(type, data) {
	        exports.HANDLERS[type].forEach(h => h(data));
	    }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const console_logger_1 = __webpack_require__(7);
	const socket_channel_1 = __webpack_require__(9);
	const default_connection_1 = __webpack_require__(69);
	const log_level_1 = __webpack_require__(8);
	class Config {
	    constructor(servers = {}, constraints = null, logLevel = log_level_1.LogLevel.ERROR, signalling) {
	        this._dataConstraints = null;
	        this._servers = servers;
	        this._dataConstraints = constraints;
	        this._signalling = signalling ? signalling : new socket_channel_1.SocketChannel();
	        this._logger = new console_logger_1.ConsoleLogger(logLevel);
	        this._connection = new default_connection_1.DefaultConnection();
	    }
	    get servers() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	class ConsoleLogger {
	    ...
	    trace(data, method) {
	        if (this._logLevel === log_level_1.LogLevel.OFF) {
	            return;
	        }
	        if (this._logLevel === log_level_1.LogLevel.WARN && method === 'error') {
	            return;
	        }
	        if (this._logLevel === log_level_1.LogLevel.INFO && (method === 'error' || method === 'warn')) {
	            return;
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	const bridge_1 = __webpack_require__(65);
	...
	class SocketChannel {
	    ...
	    onIp(ipaddr) {
	        app_1.CONFIG.logger.log.apply(app_1.CONFIG.logger, ['Server IP address is: ' + ipaddr]);
	    }
	    onLog(data) {
	        app_1.CONFIG.logger.log.apply(app_1.CONFIG.logger, [data]);
	    }
	    onMessage(event) {
	        switch (event.type) {
	            case event_type_1.SignalingEventType.OFFER:
	                bridge_1.Bridge.onOffer(event);
	                break;
	            case event_type_1.SignalingEventType.ANSWER:
	                bridge_1.Bridge.onAnswer(event);
	                break;
	            case event_type_1.SignalingEventType.CANDIDATE:
	                bridge_1.Bridge.onCandidate(event);
	                break;
	            case event_type_1.SignalingEventType.CONNECT:
	                bridge_1.Bridge.onConnect(event);
	                break;
	            case event_type_1.SignalingEventType.DISCONNECT:
	                bridge_1.Bridge.onDisconnect(event);
	                break;
	        }
	    }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	const app_1 = __webpack_require__(3);
	const event_type_1 = __webpack_require__(5);
	const factory_1 = __webpack_require__(66);
	const factory_2 = __webpack_require__(67);
	class Bridge {
	    static onConnect(event) {
	        let peer = app_1.CONFIG.connection.peers[event.caller.id] = factory_1.PeerFactory.get(app_1.CONFIG.servers, app_1.CONFIG.signalling);
	        let channel = peer.createDataChannel('chunks', app_1.CONFIG.dataConstraints);
	        app_1.CONFIG.connection.channels[event.caller.id] = factory_2.DataChannelFactory.get(channel);
	        peer.createOffer((desc) => {
	            ...
	            peer.setLocalDescription(desc, () => app_1.CONFIG.signalling.send(message), app_1.CONFIG.logger.error.bind(app_1.CONFIG.logger));
	        }, app_1.CONFIG.logger.error.bind(app_1.CONFIG.logger));
	    }
	    ...
	    static onOffer(event) {
	        let peer = app_1.CONFIG.connection.peers[event.caller.id] = factory_1.PeerFactory.get(app_1.CONFIG.servers, app_1.CONFIG.signalling);
	        peer.ondatachannel = (dataChannelEvent) => {
	            app_1.CONFIG.connection.addChannel(event.caller.id, factory_2.DataChannelFactory.get(dataChannelEvent.channel));
	        };
	    ...
	    static onAnswer(event) {
	        let peer = app_1.CONFIG.connection.peers[event.caller.id];
	        peer.setRemoteDescription(new RTCSessionDescription(event.data), () => {
	        }, app_1.CONFIG.logger.error.bind(app_1.CONFIG.logger));
	    }
	    static onDisconnect(event) {
	        let channel = app_1.CONFIG.connection.channels[event.caller.id];
	        channel.close();
	        let peer = app_1.CONFIG.connection.peers[event.caller.id];
	        peer.close();
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const event_type_1 = __webpack_require__(68);
	const dispatcher_1 = __webpack_require__(4);
	class DataChannelFactory {
	    ...
	    static onMessage(event) {
	        dispatcher_1.EventDispatcher.dispatch(event_type_1.EventType.DATA, event);
	    }
	    static onOpen(event) {
	        dispatcher_1.EventDispatcher.dispatch(event_type_1.EventType.OPEN, event);
	    }
	    static onClose(event) {
	        dispatcher_1.EventDispatcher.dispatch(event_type_1.EventType.CLOSE, event);
	    }
	    static onError(event) {
	        dispatcher_1.EventDispatcher.dispatch(event_type_1.EventType.ERROR, event);
	    }
	}
	exports.DataChannelFactory = DataChannelFactory;
	//# sourceMappingURL=factory.js.map
...
/***/ function(module, exports) {
	...
	//# sourceMappingURL=default-connection.js.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  // Utils.
	  var logging = __webpack_require__(112).log;
	  var browserDetails = __webpack_require__(112).browserDetails;
	  // Export to the adapter global object visible in the browser.
	  module.exports.browserDetails = browserDetails;
	  module.exports.extractVersion = __webpack_require__(112).extractVersion;
	  module.exports.disableLog = __webpack_require__(112).disableLog;
	  ...
	  // Browser shims.
	  var chromeShim = __webpack_require__(113) || null;
	  var edgeShim = __webpack_require__(115) || null;
	  var firefoxShim = __webpack_require__(118) || null;
	  var safariShim = __webpack_require__(120) || null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  shimGetUserMedia: __webpack_require__(114)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SDPUtils = __webpack_require__(116);
	var browserDetails = __webpack_require__(112).browserDetails;
	...
	module.exports = {
	  ...
	  shimGetUserMedia: __webpack_require__(117)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  shimGetUserMedia: __webpack_require__(119)
	};
