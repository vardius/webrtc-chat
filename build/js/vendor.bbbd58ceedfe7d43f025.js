...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "js/" + chunkId + "." + {"0":"eb0b6b1500513b1b7393"}[chunkId] + ".js";
...
var hasBinary = __webpack_require__(131);
var sliceBuffer = __webpack_require__(148);
var after = __webpack_require__(364);
...
!function(n,e){ true?e(exports,__webpack_require__(384)):"function"==typeof define&&define.amd?define(["exports","socket.io-client"],e):e(n["peer-data"]=n["peer-data"]||{},n.io)}(this,function(n,e){"use strict";var t={},o=function(){function n(){}return n.register=function(n,e){t[n]||(t[n]=[]),t[n].push(e)},n.dispatch=function(n,e){t[n].forEach(function(n){return n(e)})},n}(),r=function(){function n(){}return n}();r.CONNECT="CONNECT",r.DISCONNECT="DISCONNECT",r.CANDIDATE="CANDIDATE",r.OFFER="OFFER",r.ANSWER="ANSWER",r.ERROR="ERROR";var i=function(){function n(n,e){void 0===n&&(n={}),void 0===e&&(e=null),this._servers={},this._dataConstraints=null,this._peers={},this._channels={},this._servers=n,this._dataConstraints=e}return Object.defineProperty(n.prototype,"peers",{get:function(){return this._peers},enumerable:!0,configurable:!0}),Object.defineProperty(n.prototype,"channels",{get:function(){return this._channels},enumerable:!0,configurable:!0}),n.prototype.addPeer=function(n,e){var t=this;return this._peers.hasOwnProperty(n)||(this._peers[n]=e,e.onconnectionstatechange=function(o){"closed"===e.connectionState&&t.removePeer(n)}),this},n.prototype.getPeer=function(n){return this._peers.hasOwnProperty(n)?this._peers[n]:null},n.prototype.removePeer=function(n){return this._peers.hasOwnProperty(n)&&(this._peers[n].close(),delete this._peers[n]),this},n.prototype.addChannel=function(n,e){var t=this;return this._channels.hasOwnProperty(n)||(this._channels[n]=e,e.onclose=function(e){return t.removeChannel(n)}),this},n.prototype.getChannel=function(n){return this._channels.hasOwnProperty(n)?this._channels[n]:null},n.prototype.removeChannel=function(n){return this._channels.hasOwnProperty(n)&&(this._channels[n].close(),delete this._channels[n]),this},Object.defineProperty(n.prototype,"servers",{get:function(){return this._servers},set:function(n){this._servers=n},enumerable:!0,configurable:!0}),Object.defineProperty(n.prototype,"dataConstraints",{get:function(){return this._dataConstraints},set:function(n){this._dataConstraints=n},enumerable:!0,configurable:!0}),n}(),c=function(){function n(){}return n.get=function(n,e){var t=new RTCPeerConnection(n);return t.onicecandidate=function(n){if(n.candidate){var t={type:r.CANDIDATE,caller:null,callee:e.caller,room:e.room,data:n.candidate};o.dispatch("send",t)}},t},n}(),s=function(){function n(){}return n.get=function(n,e){var t=Math.floor(1e16*(1+Math.random())).toString(16).substring(1);return n.createDataChannel(t,e)},n}(),a=function(){function n(){}return n}();a.LOG="LOG",a.ERROR="ERROR",a.PEER="PEER",a.CHANNEL="CHANNEL";var h=function(){function n(n){this._connection=n,o.register(r.CONNECT,this.onConnect.bind(this)),o.register(r.DISCONNECT,this.onDisconnect.bind(this)),o.register(r.OFFER,this.onOffer.bind(this)),o.register(r.ANSWER,this.onAnswer.bind(this)),o.register(r.CANDIDATE,this.onCandidate.bind(this))}return Object.defineProperty(n.prototype,"connection",{get:function(){return this._connection},set:function(n){this._connection=n},enumerable:!0,configurable:!0}),n.prototype.onConnect=function(n){var e=this,t=c.get(this._connection.servers,n),o=s.get(t,this._connection.dataConstraints);this.dispatchPeer(t,n),this.dispatchChannel(o,n),this._connection.addChannel(n.caller.id,o),this._connection.addPeer(n.caller.id,t),t.createOffer(function(o){var i={type:r.OFFER,caller:null,callee:n.caller,room:n.room,data:o};t.setLocalDescription(o,function(){return e.dispatchEvent(i)},function(t){return e.dispatchError(n,t)})},function(t){return e.dispatchError(n,t)})},n.prototype.onDisconnect=function(n){this._connection.removeChannel(n.caller.id),this._connection.removePeer(n.caller.id)},n.prototype.onOffer=function(n){var e=this,t=c.get(this._connection.servers,n);this._connection.addPeer(n.caller.id,t),this.dispatchPeer(t,n),t.ondatachannel=function(t){e.dispatchChannel(t.channel,n),e._connection.addChannel(n.caller.id,t.channel)},t.setRemoteDescription(new RTCSessionDescription(n.data),function(){},function(t){return e.dispatchError(n,t)}),t.createAnswer(function(o){var i={type:r.ANSWER,caller:null,callee:n.caller,room:n.room,data:o};t.setLocalDescription(o,function(){return e.dispatchEvent(i)},function(t){return e.dispatchError(n,t)})},function(t){return e.dispatchError(n,t)})},n.prototype.onAnswer=function(n){var e=this;this._connection.getPeer(n.caller.id).setRemoteDescription(new RTCSessionDescription(n.data),function(){},function(t){return e.dispatchError(n,t)})},n.prototype.onCandidate=function(n){var e=this,t=this._connection.getPeer(n.caller.id),o=new RTCIceCandidate(n.data);t.addIceCandidate(o).then(function(){},function(t){return e.dispatchError(n,t)})},n.prototype.dispatchPeer=function(n,e){var t={caller:e.caller,room:e.room,data:n};o.dispatch(a.PEER,t)},n.prototype.dispatchChannel=function(n,e){var t={caller:e.caller,room:e.room,data:n};o.dispatch(a.CHANNEL,t)},n.prototype.dispatchEvent=function(n){o.dispatch("send",n)},n.prototype.dispatchError=function(n,e){var t={caller:n.caller,room:n.room,data:e.message};o.dispatch(a.ERROR,t)},n}(),u=function(){function n(n,e){void 0===n&&(n={}),void 0===e&&(e=null);var t=new i(n,e);this.bridge=new h(t)}return n.prototype.on=function(n,e){o.register(n,e)},n.prototype.send=function(n,e){if(e){var t=this.bridge.connection.channels[e];t&&"open"===t.readyState&&t.send(n)}else Object.entries(this.bridge.connection.channels).forEach(function(e){var t=(e[0],e[1]);"open"===t.readyState&&t.send(n)})},n.prototype.connect=function(n){var e={type:r.CONNECT,caller:null,callee:null,room:{id:n},data:null};o.dispatch("send",e)},n.prototype.disconnect=function(n){Object.entries(this.bridge.connection.channels).forEach(function(n){n[0];return n[1].close()}),Object.entries(this.bridge.connection.peers).forEach(function(n){n[0];return n[1].close()});var e={type:r.DISCONNECT,caller:null,callee:null,room:{id:n},data:null};o.dispatch("send",e)},n.prototype.peers=function(n){return n?this.bridge.connection.peers[n]:this.bridge.connection.peers},n.prototype.channels=function(n){return n?this.bridge.connection.channels[n]:this.bridge.connection.channels},n}(),p=function(){function n(n){this.socket=e.connect(n),this.subscribeEvents()}return n.prototype.onSend=function(n){this.socket.emit("message",n)},n.prototype.subscribeEvents=function(){this.socket.on("message",this.onMessage.bind(this)),this.socket.on("ipaddr",this.onIp.bind(this)),this.socket.on("log",this.onLog.bind(this)),o.register("send",this.onSend.bind(this))},n.prototype.onIp=function(n){o.dispatch(a.LOG,"Server IP address is: "+n)},n.prototype.onLog=function(){for(var n=[],e=0;e<arguments.length;e++)n[e]=arguments[e];o.dispatch(a.LOG,n)},n.prototype.onMessage=function(n){o.dispatch(n.type,n)},n}();n.default=u,n.EventDispatcher=o,n.AppEventType=a,n.SignalingEventType=r,n.SocketChannel=p,Object.defineProperty(n,"__esModule",{value:!0})});
...
var debug = __webpack_require__(355)('socket.io-parser');
...
var XHR = __webpack_require__(362);
...
var eio = __webpack_require__(358);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(8), __webpack_require__(98)))
...
(function() {
  ...
  // Browser shims.
  var chromeShim = __webpack_require__(391) || null;
  var edgeShim = __webpack_require__(393) || null;
  var firefoxShim = __webpack_require__(396) || null;
  var safariShim = __webpack_require__(398) || null;
...
var parser = __webpack_require__(49);
var parseuri = __webpack_require__(368);
...
var Polling = __webpack_require__(130);
var inherit = __webpack_require__(53);
...
if (typeof window === 'undefined') {
  try {
    NodeWebSocket = __webpack_require__(400);
  } catch (e) { }
}
...
;(function () {
  ...
  var isLoader = "function" === "function" && __webpack_require__(390);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(140)(module), __webpack_require__(8)))
...
var parseuri = __webpack_require__(387);
...
var logging = __webpack_require__(31).log;
var browserDetails = __webpack_require__(31).browserDetails;
...
module.exports = {
  ...
  shimGetUserMedia: __webpack_require__(392)
};
...
var browserDetails = __webpack_require__(31).browserDetails;
var shimRTCPeerConnection = __webpack_require__(395);
...
var SDPUtils = __webpack_require__(383);
...
module.exports = {
  ...
  shimGetUserMedia: __webpack_require__(397)
};
...
/***/ })
/******/ ]);
//# sourceMappingURL=vendor.bbbd58ceedfe7d43f025.js.map