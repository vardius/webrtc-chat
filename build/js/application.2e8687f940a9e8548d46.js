...
var _chat = __webpack_require__(309);
...
var _room = __webpack_require__(311);
...
var _participants = __webpack_require__(313);
...
var _conversation = __webpack_require__(315);
...
var _peer = __webpack_require__(317);
...
var _messageNew = __webpack_require__(321);
...
var _webComponent = __webpack_require__(25);
...
var App = exports.App = (_dec = (0, _webComponent.WebComponent)("webrtc-app", {
...
var _peerData = __webpack_require__(117);
...
module.exports = "<div class=rooms></div> <webrtc-popup></webrtc-popup> ";
...
var Room = exports.Room = (_dec = (0, _webComponent.WebComponent)("webrtc-room", {
  ...
  _createClass(Room, [{
    ...
    value: function connect() {
      ...
      if (!this.peerDataRoom && this.peerData && this.id.length > 0 && this._stream) {
        var peerDataRoom = this.peerData.connect(this._id, this._stream);
        peerDataRoom.on("participant", function (promise) {
          promise.then(function (participant) {
            var peerElem = _this2.participants.addPeer(participant.getId());

            participant.on("message", function (payload) {
            ...
            participant.on("track", function (event) {
        ...
        setTimeout(function () {
          return _this2.peerDataRoom = peerDataRoom;
        }, 500);
      }
    }
  }, {
    ...
    value: function disconnect() {
      ...
      if (this.peerDataRoom) {
        ...
        setTimeout(function () {
          return _this3.peerDataRoom = null;
        }, 500);
      }
    }
  }, {
    ...
    value: function send(data) {
      if (this.peerDataRoom) {
        this.peerDataRoom.send(JSON.stringify({
          message: data,
...
module.exports = "<div class=conversation></div> <webrtc-message-new></webrtc-message-new> ";
...
module.exports = "<textarea class=message-new placeholder=\"Press ENTER to send message...\"></textarea>";

/***/ })
],[118]);
//# sourceMappingURL=application.2e8687f940a9e8548d46.js.map