...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "js/" + chunkId + "." + {"0":"fd704f51ea830d8a71e1"}[chunkId] + ".js";
...
var XHR = __webpack_require__(357);
var JSONP = __webpack_require__(356);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(8), __webpack_require__(136)))
...
var adapterFactory = __webpack_require__(383);
...
var parser = __webpack_require__(50);
var parseuri = __webpack_require__(131);
var parsejson = __webpack_require__(374);
var parseqs = __webpack_require__(67);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(382)(module), __webpack_require__(8)))
...
exports.Socket = __webpack_require__(134);
...
module.exports = function(dependencies) {
  ...
  // Browser shims.
  var chromeShim = __webpack_require__(384) || null;
  var edgeShim = __webpack_require__(386) || null;
  var firefoxShim = __webpack_require__(389) || null;
  var safariShim = __webpack_require__(391) || null;
...
module.exports = {
  ...
  shimGetUserMedia: __webpack_require__(385)
};
...
var utils = __webpack_require__(51);
var shimRTCPeerConnection = __webpack_require__(388);

module.exports = {
  shimGetUserMedia: __webpack_require__(387),
  shimPeerConnection: function(window) {
    var browserDetails = utils.detectBrowser(window);
...
var SDPUtils = __webpack_require__(380);
...
module.exports = {
  ...
  shimGetUserMedia: __webpack_require__(390)
};
...
!function(e,n){ true?n(exports):"function"==typeof define&&define.amd?define(["exports"],n):n(e.PeerData=e.PeerData||{})}(this,function(e){"use strict";var n={},t=function(){function e(){}return e.register=function(e,t){n[e]||(n[e]=[]),n[e].push(t)},e.dispatch=function(e,t){n[e].forEach(function(e){return e(t)})},e}(),r=function(){function e(){}return e}();r.CONNECT="CONNECT",r.DISCONNECT="DISCONNECT",r.CANDIDATE="CANDIDATE",r.OFFER="OFFER",r.ANSWER="ANSWER",r.ERROR="ERROR";var o=function(){function e(e,n){void 0===e&&(e={}),void 0===n&&(n=null),this._servers={},this._dataConstraints=null,this._peers={},this._channels={},this._servers=e,this._dataConstraints=n}return Object.defineProperty(e.prototype,"peers",{get:function(){return this._peers},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"channels",{get:function(){return this._channels},enumerable:!0,configurable:!0}),e.prototype.addPeer=function(e,n){var t=this;return this._peers.hasOwnProperty(e)||(this._peers[e]=n,n.onconnectionstatechange=function(r){"closed"===n.connectionState&&t.removePeer(e)}),this},e.prototype.getPeer=function(e){return this._peers.hasOwnProperty(e)?this._peers[e]:null},e.prototype.removePeer=function(e){return this._peers.hasOwnProperty(e)&&(this._peers[e].close(),delete this._peers[e]),this},e.prototype.addChannel=function(e,n){var t=this;return this._channels.hasOwnProperty(e)||(this._channels[e]=n,n.onclose=function(n){return t.removeChannel(e)}),this},e.prototype.getChannel=function(e){return this._channels.hasOwnProperty(e)?this._channels[e]:null},e.prototype.removeChannel=function(e){return this._channels.hasOwnProperty(e)&&(this._channels[e].close(),delete this._channels[e]),this},Object.defineProperty(e.prototype,"servers",{get:function(){return this._servers},set:function(e){this._servers=e},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"dataConstraints",{get:function(){return this._dataConstraints},set:function(e){this._dataConstraints=e},enumerable:!0,configurable:!0}),e}(),i=function(){function e(){}return e.get=function(e,n){var o=new RTCPeerConnection(e);return o.onicecandidate=function(e){if(e.candidate){var o={type:r.CANDIDATE,caller:null,callee:n.caller,room:n.room,data:e.candidate};t.dispatch("send",o)}},o},e}(),c=function(){function e(){}return e.get=function(e,n){var t=Math.floor(1e16*(1+Math.random())).toString(16).substring(1);return e.createDataChannel(t,n)},e}(),s=function(){function e(){}return e}();s.LOG="LOG",s.ERROR="ERROR",s.PEER="PEER",s.CHANNEL="CHANNEL";var a=function(){function e(e){this._connection=e,t.register(r.CONNECT,this.onConnect.bind(this)),t.register(r.DISCONNECT,this.onDisconnect.bind(this)),t.register(r.OFFER,this.onOffer.bind(this)),t.register(r.ANSWER,this.onAnswer.bind(this)),t.register(r.CANDIDATE,this.onCandidate.bind(this))}return Object.defineProperty(e.prototype,"connection",{get:function(){return this._connection},set:function(e){this._connection=e},enumerable:!0,configurable:!0}),e.prototype.onConnect=function(e){var n=this,t=i.get(this._connection.servers,e),o=c.get(t,this._connection.dataConstraints);this.dispatchPeer(t,e),this.dispatchChannel(o,e),this._connection.addChannel(e.caller.id,o),this._connection.addPeer(e.caller.id,t),t.createOffer(function(o){var i={type:r.OFFER,caller:null,callee:e.caller,room:e.room,data:o};t.setLocalDescription(o,function(){return n.dispatchEvent(i)},function(t){return n.dispatchError(e,t)})},function(t){return n.dispatchError(e,t)})},e.prototype.onDisconnect=function(e){this._connection.removeChannel(e.caller.id),this._connection.removePeer(e.caller.id)},e.prototype.onOffer=function(e){var n=this,t=i.get(this._connection.servers,e);this._connection.addPeer(e.caller.id,t),this.dispatchPeer(t,e),t.ondatachannel=function(t){n.dispatchChannel(t.channel,e),n._connection.addChannel(e.caller.id,t.channel)},t.setRemoteDescription(new RTCSessionDescription(e.data),function(){},function(t){return n.dispatchError(e,t)}),t.createAnswer(function(o){var i={type:r.ANSWER,caller:null,callee:e.caller,room:e.room,data:o};t.setLocalDescription(o,function(){return n.dispatchEvent(i)},function(t){return n.dispatchError(e,t)})},function(t){return n.dispatchError(e,t)})},e.prototype.onAnswer=function(e){var n=this;this._connection.getPeer(e.caller.id).setRemoteDescription(new RTCSessionDescription(e.data),function(){},function(t){return n.dispatchError(e,t)})},e.prototype.onCandidate=function(e){var n=this,t=this._connection.getPeer(e.caller.id),r=new RTCIceCandidate(e.data);t.addIceCandidate(r).then(function(){},function(t){return n.dispatchError(e,t)})},e.prototype.dispatchPeer=function(e,n){var r={caller:n.caller,room:n.room,data:e};t.dispatch(s.PEER,r)},e.prototype.dispatchChannel=function(e,n){var r={caller:n.caller,room:n.room,data:e};t.dispatch(s.CHANNEL,r)},e.prototype.dispatchEvent=function(e){t.dispatch("send",e)},e.prototype.dispatchError=function(e,n){var r={caller:e.caller,room:e.room,data:n.message};t.dispatch(s.ERROR,r)},e}(),h=function(){function e(e,n){void 0===e&&(e={}),void 0===n&&(n=null);var t=new o(e,n);this.bridge=new a(t)}return e.prototype.on=function(e,n){t.register(e,n)},e.prototype.send=function(e,n){if(n){var t=this.bridge.connection.channels[n];t&&"open"===t.readyState&&t.send(e)}else Object.entries(this.bridge.connection.channels).forEach(function(n){n[0];var t=n[1];"open"===t.readyState&&t.send(e)})},e.prototype.connect=function(e){var n={type:r.CONNECT,caller:null,callee:null,room:{id:e},data:null};t.dispatch("send",n)},e.prototype.disconnect=function(e){var n=this.bridge.connection;Object.entries(n.channels).forEach(function(e){var t=e[0];e[1];return n.removeChannel(t)}),Object.entries(n.peers).forEach(function(e){var t=e[0];e[1];return n.removePeer(t)});var o={type:r.DISCONNECT,caller:null,callee:null,room:{id:e},data:null};t.dispatch("send",o)},e.prototype.peers=function(e){return e?this.bridge.connection.peers[e]:this.bridge.connection.peers},e.prototype.channels=function(e){return e?this.bridge.connection.channels[e]:this.bridge.connection.channels},e}(),u=function(){function e(e){this.socket=__webpack_require__(376)(e),t.register("send",this.onSend.bind(this)),this.subscribeEvents()}return e.prototype.onSend=function(e){this.socket.emit("message",e)},e.prototype.subscribeEvents=function(){this.socket.on("message",this.onMessage.bind(this)),this.socket.on("ipaddr",this.onIp.bind(this)),this.socket.on("log",this.onLog.bind(this))},e.prototype.onIp=function(e){t.dispatch(s.LOG,"Server IP address is: "+e)},e.prototype.onLog=function(){for(var e=[],n=0;n<arguments.length;n++)e[n]=arguments[n];t.dispatch(s.LOG,e)},e.prototype.onMessage=function(e){t.dispatch(e.type,e)},e}();e.default=h,e.EventDispatcher=t,e.AppEventType=s,e.SignalingEventType=r,e.SocketChannel=u,Object.defineProperty(e,"__esModule",{value:!0})});
...
/******/ });
//# sourceMappingURL=vendor.15b10653e4a0d83d348e.js.map